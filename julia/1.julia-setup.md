...
- [More Information about `startup.jl`](https://docs.julialang.org/en/v1/manual/command-line-interface/#Startup-file)
- Windows users can find their Julia config file in `JULIA_INSTALL_FOLDER\etc\julia\startup.jl`
...
Environment:
  JULIA_NUM_THREADS = 1
  JULIA_PROJECT = @.
  JULIA_PKG_SERVER = https://mirror.iscas.ac.cn/julia
```
